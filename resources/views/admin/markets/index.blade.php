                                ...
                                @foreach($markets as $market)
                                    <tr>
                                        ...
                                        <td>                                            
                                            ...
                                            <form action="{{ route('admin.markets.destroy', ['market' => $market->id, 'locale' => app()->getLocale()]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
